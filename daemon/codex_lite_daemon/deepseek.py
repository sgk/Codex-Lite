...
DEEPSEEK_MODELS = (DEEPSEEK_MODEL, DEEPSEEK_PRO_MODEL, DEEPSEEK_VISION_MODEL)
...
# Keep the catalog limited to the currently supported Codex models and leave the
...
_MODEL_CATALOG["models"].append(
    {
        **_MODEL_CATALOG["models"][0],
...
_MODEL_CATALOG["models"].append(
    {
        **_MODEL_CATALOG["models"][0],
        ...
        "description": "DeepSeek V4 Flash Vision Experimental",
        "priority": 3,
    }
)
...
def deepseek_model_ids() -> list[str]:
    return list(DEEPSEEK_MODELS) if deepseek_api_key_configured() else []
