...
public sealed record AppRestartPreparationDto(int MarkedCount);

public sealed record AppRestartResumeItemDto(string ProjectId, string ChatId, string MessageId, string RunId);

public sealed record AppRestartResumeFailureDto(string ProjectId, string ChatId, string Code);

public sealed record AppRestartResumeDto(
    IReadOnlyList<AppRestartResumeItemDto> Resumed,
    IReadOnlyList<AppRestartResumeFailureDto> Failed,
    int PendingCount);
